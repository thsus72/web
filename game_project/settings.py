...
SECRET_KEY = 'django-insecure-lmf(2_9bl$9n1#z17y4=4iux)5_ewceqn&*=z)nhn$3ma8hwns'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = config('EMAIL_HOST_USER')  # 환경 변수에서 가져옴
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD') # 환경 변수에서 가져옴
